  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-[var(--text-2)]">Conteúdo completo da semana 1 a 42 para mãe e bebê.</p>
      </header>
      ...
      <Card className="space-y-2 text-sm text-[var(--text-2)]">
        <p><strong>Desenvolvimento do bebê:</strong> {guide.baby_development}</p>
        <p><strong>Tamanho comparativo:</strong> {guide.baby_size_comparison}</p>
        <p><strong>Mudanças no corpo:</strong> {guide.maternal_changes}</p>
        <p><strong>Sintomas comuns:</strong> {guide.common_symptoms}</p>
        <p><strong>Alimentação:</strong> {guide.nutrition_tips}</p>
        <p><strong>Exercícios:</strong> {guide.exercise_tips}</p>
